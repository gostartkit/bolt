Bolt [![Coverage Status](https://coveralls.io/repos/boltdb/bolt/badge.svg?branch=master)](https://coveralls.io/r/boltdb/bolt?branch=master) [![GoDoc](https://godoc.org/pkg.gostartkit.com/bolt?status.svg)](https://godoc.org/pkg.gostartkit.com/bolt) ![Version](https://img.shields.io/badge/version-1.2.1-green.svg)
====
...
```sh
$ go get pkg.gostartkit.com/bolt/...
```
...
system's page cache. See the [`Tx`](https://godoc.org/pkg.gostartkit.com/bolt#Tx)
...
[page-allocation]: https://pkg.gostartkit.com/bolt/issues/308#issuecomment-74811638
